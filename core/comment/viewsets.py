...
class CommentViewSet(AbstractViewSet):
    http_method_names = ('post', 'get', 'delete', 'put', 'delete')
    ...
    # when the user hits the endpoint /api/post/pk/comment/comment_pk/
    def get_object(self):
    ...
    # when the user hits the endpoint /api/post/pk/comment/
